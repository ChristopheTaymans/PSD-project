...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		libraryName: "be.infrabel.ps.reuse",

		dir: {
			src: "src",
			test: "test",
			dist: "dist",
			sapui5: "../sapui5_sources"
		},
			...
			library: {
				...
				libraries: {
					"be/infrabel/ps/reuse": {
						src: [
							"be/infrabel/ps/reuse/**",
							"!be/infrabel/ps/reuse/thirdparty/**"
						]
					}
				}
			}
		...
		copy: {
			dist: {
				files: [
					...
					{
						//then everything else "be/infrabel/ps/library/themes/**",
						expand: true,
						cwd: "<%= dir.src %>",
						src: [
							"be/infrabel/ps/reuse/thirdparty/**",
							"be/infrabel/ps/reuse/.library",
							"be/infrabel/ps/reuse/library.js"
						],
						dest: "<%= dir.dist %>/resources"
					},
					{
		...
		compress: {
			dist: {
				options: {
					archive: "<%= dir.dist %>/infrabel-ps-library.zip"
				},
				expand: true,
