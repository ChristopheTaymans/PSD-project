sap.ui.define([
	...
	oComponent.prototype.init = function () {
		...
		this._InputHelper = new InputHelper({
			...
			.then(function (oValueHelpComponent) {
				...
				this.getModel("appSetting").setProperty("/oValueHelpComponent", oValueHelpComponent);
				// initlize router -> view will be called only when value help component is loaded		
	...
	oComponent.prototype.destroy = function () {
		if (this.getModel("appSetting").getProperty("/oValueHelpComponent")) {
			this.getModel("appSetting").getProperty("/oValueHelpComponent").destroy();
		}
